(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.OpenEdit=t())})(this,function(){var e=200,t=class{undoStack=[];redoStack=[];_paused=!1;push(t){this._paused||(this.undoStack.push(n(t)),this.undoStack.length>e&&this.undoStack.shift(),this.redoStack=[])}undo(e){return this.undoStack.length===0?null:(this.redoStack.push(n(e)),this.undoStack.pop())}redo(e){return this.redoStack.length===0?null:(this.undoStack.push(n(e)),this.redoStack.pop())}canUndo(){return this.undoStack.length>0}canRedo(){return this.redoStack.length>0}pause(){this._paused=!0}resume(){this._paused=!1}clear(){this.undoStack=[],this.redoStack=[]}};function n(e){return structuredClone(e)}function r(e){return{children:e??[i()]}}function i(e=``){return{type:`paragraph`,children:e?[o(e)]:[o(``)]}}function a(e,t=``){return{type:`heading`,level:e,children:[o(t)]}}function o(e,t=[]){return{type:`text`,text:e,marks:t}}function s(e=``){return{type:`list_item`,children:[o(e)]}}function c(e=[``]){return{type:`bullet_list`,children:e.map(s)}}function l(e=[``]){return{type:`ordered_list`,children:e.map(s)}}function u(e=``){return{type:`blockquote`,children:[i(e)]}}function d(e=``,t){return{type:`code_block`,lang:t,children:[o(e)]}}function f(e=``,t=`info`){return{type:`callout`,variant:t,children:[o(e)]}}function p(){return r([i(``)])}var m=[`info`,`success`,`warning`,`danger`];function h(e){if(!e||e.trim()===``)return p();let t=document.createElement(`div`);t.innerHTML=g(e);let n=_(t);return n.length===0?p():{children:n}}function g(e){return e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,``).replace(/\s+on\w+="[^"]*"/gi,``).replace(/\s+on\w+='[^']*'/gi,``)}function _(e){let t=[];for(let n of Array.from(e.childNodes)){if(n.nodeType===Node.TEXT_NODE){let e=(n.textContent??``).trim();e&&t.push(i(e));continue}if(n.nodeType!==Node.ELEMENT_NODE)continue;let e=n,r=v(e,e.tagName.toLowerCase());r&&t.push(r)}return t}function v(e,t){switch(t){case`p`:return y(e);case`h1`:case`h2`:case`h3`:case`h4`:case`h5`:case`h6`:return b(e,parseInt(t[1]));case`blockquote`:return x(e);case`pre`:return ee(e);case`ul`:return te(e);case`ol`:return ne(e);case`img`:return ae(e);case`hr`:return{type:`hr`};case`div`:return e.classList.contains(`oe-callout`)?ie(e):_(e)[0]??null;case`section`:case`article`:case`main`:return _(e)[0]??null;case`br`:return i(``);default:return y(e)}}function y(e){let t=C(e),n=S(e);return{type:`paragraph`,...t?{align:t}:{},children:n}}function b(e,t){let n=C(e),r=S(e);return{type:`heading`,level:t,...n?{align:n}:{},children:r}}function x(e){let t=_(e);return t.length===0&&t.push(i(``)),{type:`blockquote`,children:t}}function ee(e){let t=e.querySelector(`code`),n=t?t.textContent??``:e.textContent??``,r=t?.className.match(/language-(\w+)/)?.[1];return{type:`code_block`,...r?{lang:r}:{},children:[o(n)]}}function te(e){let t=Array.from(e.querySelectorAll(`:scope > li`)).map(re);return t.length===0&&t.push({type:`list_item`,children:[o(``)]}),{type:`bullet_list`,children:t}}function ne(e){let t=parseInt(e.getAttribute(`start`)??`1`),n=Array.from(e.querySelectorAll(`:scope > li`)).map(re);return n.length===0&&n.push({type:`list_item`,children:[o(``)]}),{type:`ordered_list`,...t===1?{}:{start:t},children:n}}function re(e){return{type:`list_item`,children:S(e)}}function ie(e){let t=e.getAttribute(`data-callout-variant`);return{type:`callout`,variant:m.includes(t)?t:m.find(t=>e.classList.contains(`oe-callout-${t}`))??`info`,children:S(e)}}function ae(e){return{type:`image`,src:e.getAttribute(`src`)??``,alt:e.getAttribute(`alt`)??void 0,width:e.getAttribute(`width`)?parseInt(e.getAttribute(`width`)):void 0,height:e.getAttribute(`height`)?parseInt(e.getAttribute(`height`)):void 0}}function S(e,t=[]){let n=[];for(let r of Array.from(e.childNodes)){if(r.nodeType===Node.TEXT_NODE){let e=r.textContent??``;e&&n.push(o(e,[...t]));continue}if(r.nodeType!==Node.ELEMENT_NODE)continue;let e=r,i=e.tagName.toLowerCase(),a=oe(i,e,t);if(i===`br`){n.push({type:`hardbreak`});continue}if(i===`img`){n.push(o(`[image]`,t));continue}n.push(...S(e,a))}return n.length===0&&n.push(o(``,t)),n}function oe(e,t,n){let r=[...n];switch(e){case`strong`:case`b`:r.some(e=>e.type===`bold`)||r.push({type:`bold`});break;case`em`:case`i`:r.some(e=>e.type===`italic`)||r.push({type:`italic`});break;case`u`:r.some(e=>e.type===`underline`)||r.push({type:`underline`});break;case`s`:case`del`:case`strike`:r.some(e=>e.type===`strikethrough`)||r.push({type:`strikethrough`});break;case`code`:r.some(e=>e.type===`code`)||r.push({type:`code`});break;case`a`:{let e={type:`link`,href:t.getAttribute(`href`)??``,target:t.getAttribute(`target`)===`_blank`?`_blank`:`_self`};r.some(e=>e.type===`link`)||r.push(e);break}case`mark`:break}return r}function C(e){let t=(e.getAttribute(`style`)??``).match(/text-align\s*:\s*(left|center|right|justify)/);return t?t[1]:void 0}function w(e){return e.children.map(T).join(`
...
`)}\n</blockquote>`;case`code_block`:{let t=D(e.children.map(e=>e.text).join(``));return`<pre><code${e.lang?` class="language-${e.lang}"`:``}>${t}</code></pre>`}case`bullet_list`:return`<ul>\n${e.children.map(e=>`  <li>${E(e.children)}</li>`).join(`
`)}\n</ul>`;case`ordered_list`:return`<ol${e.start&&e.start!==1?` start="${e.start}"`:``}>\n${e.children.map(e=>`  <li>${E(e.children)}</li>`).join(`
`)}\n</ol>`;case`image`:{let t=e.alt?` alt="${O(e.alt)}"`:``,n=e.width?` width="${e.width}"`:``,r=e.height?` height="${e.height}"`:``;return`<img src="${O(e.src)}"${t}${n}${r}>`}case`hr`:return`<hr>`;case`callout`:{let t=E(e.children);return`<div class="oe-callout oe-callout-${e.variant}" data-callout-variant="${e.variant}">${t||`<br>`}</div>`}default:return``}}function E(e){return e.map(se).join(``)}function se(e){if(e.type===`hardbreak`)return`<br>`;let t=D(e.text);if(t===``&&e.marks.length===0)return``;let n=[...e.marks].sort(ce);for(let e of n)t=le(t,e);return t}function ce(e,t){let n=[`strikethrough`,`underline`,`italic`,`bold`,`link`,`code`];return n.indexOf(e.type)-n.indexOf(t.type)}function le(e,t){switch(t.type){case`bold`:return`<strong>${e}</strong>`;case`italic`:return`<em>${e}</em>`;case`underline`:return`<u>${e}</u>`;case`code`:return`<code>${e}</code>`;case`strikethrough`:return`<s>${e}</s>`;case`link`:{let n=t,r=n.target===`_blank`?` target="_blank" rel="noopener noreferrer"`:``,i=n.title?` title="${O(n.title)}"`:``;return`<a href="${O(n.href)}"${r}${i}>${e}</a>`}default:return e}}function D(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function O(e){return e.replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`)}function ue(e){return e.children.map(de).filter(Boolean).join(`

`)}function de(e){switch(e.type){case`paragraph`:return k(e.children);case`heading`:return`${`#`.repeat(e.level)} ${k(e.children)}`;case`blockquote`:return e.children.map(de).join(`
...
`).map(e=>e?`> ${e}`:`>`).join(`
`)}`;default:return``}}function k(e){return e.map(fe).join(``)}function fe(e){if(e.type===`hardbreak`)return`
`;let t=e.text,n=[...e.marks].sort((e,t)=>{let n=[`link`,`bold`,`italic`,`strikethrough`,`underline`,`code`];return n.indexOf(e.type)-n.indexOf(t.type)});for(let e of n)switch(e.type){case`bold`:t=`**${t}**`;break;case`italic`:t=`*${t}*`;break;case`code`:t=`\`${t}\``;break;case`strikethrough`:t=`~~${t}~~`;break;case`underline`:t=`<u>${t}</u>`;break;case`link`:{let n=e,r=n.title?` "${n.title}"`:``;t=`[${t}](${n.href}${r})`;break}}return t}function A(e){if(!e||e.trim()===``)return p();let t=pe(e);return t.length>0?{children:t}:p()}function pe(e){let t=e.split(`
`),n=[],r=0;for(;r<t.length;){let e=t[r];if(e.trim()===``){r++;continue}let a=e.match(/^(`{3,}|~{3,})(.*)/);if(a){let e=a[1],i=a[2].trim();r++;let s=[];for(;r<t.length&&!t[r].startsWith(e);)s.push(t[r]),r++;r<t.length&&r++,n.push({type:`code_block`,...i?{lang:i}:{},children:[o(s.join(`
`))]});continue}let s=e.match(/^(#{1,6})\s+(.*)/);if(s){let e=s[1].length;n.push({type:`heading`,level:e,children:j(s[2].trim())}),r++;continue}if(/^[-*_]{3,}\s*$/.test(e.trim())){n.push({type:`hr`}),r++;continue}if(e.startsWith(`>`)){let e=[];for(;r<t.length&&t[r].startsWith(`>`);)e.push(t[r].slice(1).trimStart()),r++;let a=e[0]?.match(/^\[!(info|success|warning|danger)\]$/i);if(a){let t=a[1].toLowerCase(),r=e.slice(1).join(`
`);n.push({type:`callout`,variant:t,children:j(r)});continue}let o=pe(e.join(`
`));n.push({type:`blockquote`,children:o.length>0?o:[i(``)]});continue}if(/^[-*+] /.test(e)){let e=[];for(;r<t.length&&/^[-*+] /.test(t[r]);)e.push({type:`list_item`,children:j(t[r].replace(/^[-*+]\s+/,``))}),r++;n.push({type:`bullet_list`,children:e});continue}if(/^\d+\. /.test(e)){let i=[],a=e.match(/^(\d+)\./),o=a?parseInt(a[1]):1;for(;r<t.length&&/^\d+\. /.test(t[r]);)i.push({type:`list_item`,children:j(t[r].replace(/^\d+\.\s+/,``))}),r++;n.push({type:`ordered_list`,...o===1?{}:{start:o},children:i});continue}let c=e.match(/^!\[([^\]]*)\]\(([^)]+)\)\s*$/);if(c){n.push({type:`image`,alt:c[1]||void 0,src:c[2]}),r++;continue}let l=[];for(;r<t.length&&t[r].trim()!==``&&!me(t[r]);)l.push(t[r]),r++;l.length>0&&n.push({type:`paragraph`,children:j(l.join(` `))})}return n}function me(e){return/^#{1,6}\s/.test(e)||/^(`{3,}|~{3,})/.test(e)||e.startsWith(`>`)||/^[-*+] /.test(e)||/^\d+\. /.test(e)||/^[-*_]{3,}\s*$/.test(e.trim())}var he=[{re:/`([^`]+)`/,priority:0,handler:e=>[o(e[1],[{type:`code`}])]},{re:/\[([^\]]+)\]\(([^) "]+)(?:\s+"([^"]*)")?\)/,priority:1,handler:e=>{let t=j(e[1]),n={type:`link`,href:e[2],target:`_self`,...e[3]?{title:e[3]}:{}};return t.map(e=>e.type===`text`?o(e.text,[...e.marks,n]):e)}},{re:/!\[([^\]]*)\]\(([^)]+)\)/,priority:1,handler:e=>[o(`[${e[1]||`image`}]`,[])]},{re:/\*\*([^*]+)\*\*|__([^_]+)__/,priority:2,handler:e=>M(e[1]??e[2],{type:`bold`})},{re:/\*([^*]+)\*|_([^_]+)_/,priority:3,handler:e=>M(e[1]??e[2],{type:`italic`})},{re:/~~([^~]+)~~/,priority:2,handler:e=>M(e[1],{type:`strikethrough`})},{re:/<u>([^<]+)<\/u>/,priority:2,handler:e=>M(e[1],{type:`underline`})}];function j(e){if(!e)return[o(``,[])];let t=[],n=e;for(;n.length>0;){let e=null;for(let t of he){let r=new RegExp(t.re.source,t.re.flags.replace(`g`,``)).exec(n);if(r===null)continue;let i=r.index;(!e||i<e.index||i===e.index&&t.priority<e.pattern.priority||i===e.index&&t.priority===e.pattern.priority&&r[0].length>e.match[0].length)&&(e={index:i,match:r,pattern:t})}if(!e){t.push(o(n,[]));break}e.index>0&&t.push(o(n.slice(0,e.index),[])),t.push(...e.pattern.handler(e.match)),n=n.slice(e.index+e.match[0].length)}return t.length>0?t:[o(e,[])]}function M(e,t){return j(e).map(e=>e.type===`text`?o(e.text,[...e.marks,t]):e)}function N(e,t){let n=document.createDocumentFragment();for(let t of e.children){let e=P(t);n.appendChild(e)}t.innerHTML=``,t.appendChild(n)}function P(e){switch(e.type){case`paragraph`:{let t=document.createElement(`p`);return e.align&&e.align!==`left`&&(t.style.textAlign=e.align),F(e.children,t),t}case`heading`:{let t=document.createElement(`h${e.level}`);return e.align&&e.align!==`left`&&(t.style.textAlign=e.align),F(e.children,t),t}case`blockquote`:{let t=document.createElement(`blockquote`);for(let n of e.children)t.appendChild(P(n));return t}case`code_block`:{let t=document.createElement(`pre`),n=document.createElement(`span`);n.className=`oe-code-lang-badge`,n.contentEditable=`false`,n.textContent=e.lang||`plain`,t.appendChild(n);let r=document.createElement(`code`);return e.lang&&(r.className=`language-${e.lang}`),r.textContent=e.children.map(e=>e.text).join(``),t.appendChild(r),t}case`bullet_list`:{let t=document.createElement(`ul`);for(let n of e.children){let e=document.createElement(`li`);F(n.children,e),t.appendChild(e)}return t}case`ordered_list`:{let t=document.createElement(`ol`);e.start&&e.start!==1&&t.setAttribute(`start`,String(e.start));for(let n of e.children){let e=document.createElement(`li`);F(n.children,e),t.appendChild(e)}return t}case`image`:{let t=document.createElement(`div`);t.className=`oe-image-wrapper`;let n=document.createElement(`img`);return n.src=e.src,e.alt&&(n.alt=e.alt),e.width&&(n.width=e.width),e.height&&(n.height=e.height),n.draggable=!1,t.appendChild(n),t}case`hr`:return document.createElement(`hr`);case`callout`:{let t=document.createElement(`div`);return t.className=`oe-callout oe-callout-${e.variant}`,t.dataset.calloutVariant=e.variant,F(e.children,t),t}default:{let e=document.createElement(`p`);return e.textContent=``,e}}}function F(e,t){if(e.length===0||e.length===1&&e[0].type===`text`&&e[0].text===``){t.appendChild(document.createElement(`br`));return}for(let n of e){if(n.type===`hardbreak`){t.appendChild(document.createElement(`br`));continue}let e=document.createTextNode(n.text),r=[...n.marks];for(let t of r.reverse())e=ge(e,t);t.appendChild(e)}}function ge(e,t){let n;switch(t.type){case`bold`:n=document.createElement(`strong`);break;case`italic`:n=document.createElement(`em`);break;case`underline`:n=document.createElement(`u`);break;case`strikethrough`:n=document.createElement(`s`);break;case`code`:n=document.createElement(`code`);break;case`link`:{let e=t,r=document.createElement(`a`);r.href=e.href,e.target===`_blank`&&(r.target=`_blank`,r.rel=`noopener noreferrer`),e.title&&(r.title=e.title),n=r;break}default:n=document.createElement(`span`)}return n.appendChild(e),n}function I(e){let t=e.innerHTML;return h(t)}function L(e,t){document.execCommand(e,!1,t??void 0)}function _e(e,t,n,r){let o=[...e.children],s=o[t];if(!s)return e;let p=z(s),m;switch(n){case`paragraph`:m={...i(p),...r??{}};break;case`heading`:m=a(r?.level??1,p);break;case`h1`:case`H1`:m=a(1,p);break;case`h2`:case`H2`:m=a(2,p);break;case`h3`:case`H3`:m=a(3,p);break;case`h4`:case`H4`:m=a(4,p);break;case`h5`:case`H5`:m=a(5,p);break;case`h6`:case`H6`:m=a(6,p);break;case`blockquote`:case`BLOCKQUOTE`:m=u(p);break;case`code_block`:case`PRE`:m=d(p,r?.lang);break;case`bullet_list`:m=c([p]);break;case`ordered_list`:m=l([p]);break;case`callout`:m=f(p,r?.variant??`info`);break;case`CALLOUT-info`:case`CALLOUT-success`:case`CALLOUT-warning`:case`CALLOUT-danger`:{let e=n.split(`-`)[1];m=f(p,e);break}default:m=i(p)}return o[t]=m,{children:o}}function ve(e,t,n){let r=[...e.children],a=r[t];if(!a)return e;if(a.type===n){let e=a.children.map(e=>i(e.children.map(e=>e.type===`text`?e.text:``).join(``)));r.splice(t,1,...e)}else if(a.type===`bullet_list`||a.type===`ordered_list`){let e=a;n===`bullet_list`?r[t]={type:`bullet_list`,children:e.children}:r[t]={type:`ordered_list`,children:e.children}}else{let e=z(a);r[t]=n===`bullet_list`?c([e]):l([e])}return{children:r}}function ye(e,t,n){let r=[...e.children],i=r[t];return i?((i.type===`paragraph`||i.type===`heading`)&&(r[t]={...i,align:n}),{children:r}):e}function R(e,t,n,r){let a=[...e.children],o={type:`image`,src:n,alt:r};return a.splice(t+1,0,o,i(``)),{children:a}}function be(e,t){let n=[...e.children];return n.splice(t+1,0,{type:`hr`},i(``)),{children:n}}function z(e){return e.type===`paragraph`||e.type===`heading`||e.type===`list_item`||e.type===`code_block`||e.type===`callout`?e.children.map(e=>e.type===`text`?e.text:``).join(``):e.type===`bullet_list`||e.type===`ordered_list`?e.children.map(e=>e.children.map(e=>e.type===`text`?e.text:``).join(``)).join(` `):e.type===`blockquote`?e.children.map(z).join(` `):``}function xe(e){let t=window.getSelection();if(!t||t.rangeCount===0)return`p`;let n=t.anchorNode;for(;n&&n.parentNode!==e;)n=n.parentNode;if(!n||n.nodeType!==Node.ELEMENT_NODE)return`p`;let r=n.tagName.toLowerCase();return r===`h1`?`H1`:r===`h2`?`H2`:r===`h3`?`H3`:r===`h4`?`H4`:r===`blockquote`?`BLOCKQUOTE`:r===`pre`?`PRE`:r===`ul`?`bullet_list`:r===`ol`?`ordered_list`:r===`div`&&n.classList?.contains(`oe-callout`)?`CALLOUT-${n.dataset?.calloutVariant??`info`}`:`P`}function Se(e,t){document.execCommand(`createLink`,!1,e);let n=window.getSelection();if(n&&n.rangeCount>0){let e=n.getRangeAt(0).startContainer.parentElement?.closest(`a`);e&&(e.target=t,t===`_blank`&&(e.rel=`noopener noreferrer`))}}function B(e,t){let n=window.getSelection();if(!n||n.rangeCount===0)return null;let r=n.getRangeAt(0);if(!e.contains(r.commonAncestorContainer))return null;let i=V(e,n.anchorNode,n.anchorOffset),a=V(e,n.focusNode,n.focusOffset);return!i||!a?null:{anchor:i,focus:a,isCollapsed:n.isCollapsed}}function V(e,t,n){let r=null,i=t;for(;i&&i!==e;){if(i.parentNode===e&&i.nodeType===Node.ELEMENT_NODE){r=i;break}i=i.parentNode}if(!r)return null;let a=Array.from(e.children).indexOf(r);if(a<0)return null;let o=we(r,t,n),s=Ce(t,r);if(s){let e=s.parentElement;return{blockIndex:a,itemIndex:Array.from(e.children).indexOf(s),offset:o}}return{blockIndex:a,offset:o}}function Ce(e,t){let n=e;for(;n&&n!==t;){if(n.nodeType===Node.ELEMENT_NODE&&n.tagName===`LI`)return n;n=n.parentNode}return null}function we(e,t,n){return H(e,t,n,{count:0,done:!1,result:0}).result}function H(e,t,n,r){if(r.done)return r;if(e===t)return r.result=r.count+(e.nodeType===Node.TEXT_NODE?n:0),r.done=!0,r;if(e.nodeType===Node.TEXT_NODE)return r.count+=(e.textContent??``).length,r;if(e.nodeType===Node.ELEMENT_NODE&&e.tagName.toLowerCase()===`br`)return e===t&&(r.result=r.count,r.done=!0),r;for(let i of Array.from(e.childNodes))if(r=H(i,t,n,r),r.done)break;return r}function U(e){let t=window.getSelection();if(!t||t.rangeCount===0)return 0;let n=t.anchorNode;for(;n&&n.parentNode!==e;)n=n.parentNode;return n?Array.from(e.children).indexOf(n):0}function W(e){let t=window.getSelection(),n=new Set;if(!t||t.rangeCount===0)return n;let r=t.getRangeAt(0);if(!e.contains(r.commonAncestorContainer))return n;let i=t.anchorNode;for(;i&&i!==e;){if(i.nodeType===Node.ELEMENT_NODE){let e=i.tagName.toLowerCase();(e===`strong`||e===`b`)&&n.add(`bold`),(e===`em`||e===`i`)&&n.add(`italic`),e===`u`&&n.add(`underline`),(e===`s`||e===`del`)&&n.add(`strikethrough`),e===`code`&&n.add(`code`),e===`a`&&n.add(`link`)}i=i.parentNode}return n}var G={toolbar:{undo:`Undo (Ctrl+Z)`,redo:`Redo (Ctrl+Y)`,textFormat:`Text Format`,paragraph:`Paragraph`,heading:e=>`Heading ${e}`,quote:`Quote`,codeBlock:`Code Block`,bold:`Bold (Ctrl+B)`,italic:`Italic (Ctrl+I)`,underline:`Underline (Ctrl+U)`,inlineCode:"Inline Code (Ctrl+`)",alignLeft:`Align Left`,alignCenter:`Align Center`,alignRight:`Align Right`,justify:`Justify`,bulletList:`Bullet List`,orderedList:`Ordered List`,insertLink:`Insert Link`,insertImage:`Insert Image`,blockquote:`Blockquote`,horizontalRule:`Horizontal Rule`,htmlSource:`Toggle HTML Source`,calloutInfo:`Callout: Info`,calloutSuccess:`Callout: Success`,calloutWarning:`Callout: Warning`,calloutDanger:`Callout: Danger`,insertCallout:`Insert Callout`},statusBar:{words:`Words`,characters:`Characters`,htmlSource:`HTML`},dialogs:{linkUrl:`Link URL:`,openInNewTab:`Open in new tab?`,imageUrl:`Image URL:`,imageAlt:`Alt text (optional):`},plugins:{ai:{panelTitle:`AI Assistant`,noSelection:`(No text selected — entire document will be used)`,customPromptPlaceholder:`Enter custom instruction…`,runButton:`Run`,applyButton:`Apply`,generating:`⏳ Generating…`,noApiKey:`⚠️ No API key configured. Pass apiKey or endpoint when creating the plugin.`,errorPrefix:`❌ Error: `,actions:{improve:`Improve`,shorten:`Shorten`,expand:`Expand`,summarize:`Summarize`,toGerman:`🇩🇪 To German`,toEnglish:`🇬🇧 To English`}},emoji:{buttonTitle:`Insert emoji`,categories:{faces:`Faces`,hearts:`Hearts`,gestures:`Gestures`,nature:`Nature`,food:`Food`,objects:`Objects`,symbols:`Symbols`}}}},Te=`width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"`;function K(e){return`<svg ${Te}>${e}</svg>`}var Ee={undo:K(`<path d="M3 7h10a6 6 0 0 1 0 12H9"/><path d="M3 7l4-4M3 7l4 4"/>`),redo:K(`<path d="M21 7H11a6 6 0 0 0 0 12h4"/><path d="M21 7l-4-4M21 7l-4 4"/>`),bold:K(`<path d="M6 4h8a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z"/><path d="M6 12h9a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z"/>`),italic:K(`<line x1="19" y1="4" x2="10" y2="4"/><line x1="14" y1="20" x2="5" y2="20"/><line x1="15" y1="4" x2="9" y2="20"/>`),underline:K(`<path d="M6 4v6a6 6 0 0 0 12 0V4"/><line x1="4" y1="20" x2="20" y2="20"/>`),strikethrough:K(`<path d="M17.3 12H12m-6 0h3"/><line x1="3" y1="12" x2="21" y2="12"/><path d="M7 7.5C7 5.6 9 4 12 4s5 1.6 5 3.5c0 .7-.3 1.4-.8 2"/><path d="M17 16.5C17 18.4 15 20 12 20s-5-1.6-5-3.5"/>`),code_inline:K(`<polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/>`),link:K(`<path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/>`),image:K(`<rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21,15 16,10 5,21"/>`),blockquote:K(`<path d="M3 21c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2H4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1z"/><path d="M15 21c3 0 7-1 7-8V5c0-1.25-.757-2.017-2-2h-4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2h.75c0 2.25.25 4-2.75 4v3c0 1 0 1 1 1z"/>`),hr:K(`<line x1="5" y1="12" x2="19" y2="12"/>`),alignLeft:K(`<line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="15" y2="12"/><line x1="3" y1="18" x2="18" y2="18"/>`),alignCenter:K(`<line x1="3" y1="6" x2="21" y2="6"/><line x1="6" y1="12" x2="18" y2="12"/><line x1="4" y1="18" x2="20" y2="18"/>`),alignRight:K(`<line x1="3" y1="6" x2="21" y2="6"/><line x1="9" y1="12" x2="21" y2="12"/><line x1="6" y1="18" x2="21" y2="18"/>`),alignJustify:K(`<line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/>`),bulletList:K(`<circle cx="4" cy="7" r="1.5" fill="currentColor"/><line x1="8" y1="7" x2="21" y2="7"/><circle cx="4" cy="12" r="1.5" fill="currentColor"/><line x1="8" y1="12" x2="21" y2="12"/><circle cx="4" cy="17" r="1.5" fill="currentColor"/><line x1="8" y1="17" x2="21" y2="17"/>`),orderedList:K(`<line x1="10" y1="6" x2="21" y2="6"/><line x1="10" y1="12" x2="21" y2="12"/><line x1="10" y1="18" x2="21" y2="18"/><path d="M4 6h1v4"/><path d="M4 10h2"/><path d="M6 18H4c0-1 2-2 2-3s-1-1.5-2-1"/>`),htmlToggle:K(`<path d="M10 9l-3 3 3 3"/><path d="M14 15l3-3-3-3"/><rect x="2" y="3" width="20" height="18" rx="2"/>`),maximize:K(`<path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M21 8V5a2 2 0 0 0-2-2h-3"/><path d="M3 16v3a2 2 0 0 0 2 2h3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/>`),callout:K(`<circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>`)};function q(e){let t=e.toolbar;return[{type:`button`,id:`undo`,icon:`undo`,title:t.undo,command:`undo`},{type:`button`,id:`redo`,icon:`redo`,title:t.redo,command:`redo`},{type:`separator`},{type:`select`,id:`blockType`,title:t.textFormat,command:`setBlock`,options:[{label:t.paragraph,value:`P`},{label:t.heading(1),value:`H1`},{label:t.heading(2),value:`H2`},{label:t.heading(3),value:`H3`},{label:t.heading(4),value:`H4`},{label:t.quote,value:`BLOCKQUOTE`},{label:t.codeBlock,value:`PRE`},{label:t.calloutInfo,value:`CALLOUT-info`},{label:t.calloutSuccess,value:`CALLOUT-success`},{label:t.calloutWarning,value:`CALLOUT-warning`},{label:t.calloutDanger,value:`CALLOUT-danger`}],getValue:e=>e.getActiveBlockType()},{type:`separator`},{type:`button`,id:`bold`,icon:`bold`,title:t.bold,command:`bold`,isActive:e=>e.isMarkActive(`bold`)},{type:`button`,id:`italic`,icon:`italic`,title:t.italic,command:`italic`,isActive:e=>e.isMarkActive(`italic`)},{type:`button`,id:`underline`,icon:`underline`,title:t.underline,command:`underline`,isActive:e=>e.isMarkActive(`underline`)},{type:`button`,id:`code`,icon:`code_inline`,title:t.inlineCode,command:`code`,isActive:e=>e.isMarkActive(`code`)},{type:`separator`},{type:`button`,id:`alignLeft`,icon:`alignLeft`,title:t.alignLeft,command:`alignLeft`},{type:`button`,id:`alignCenter`,icon:`alignCenter`,title:t.alignCenter,command:`alignCenter`},{type:`button`,id:`alignRight`,icon:`alignRight`,title:t.alignRight,command:`alignRight`},{type:`button`,id:`alignJustify`,icon:`alignJustify`,title:t.justify,command:`alignJustify`},{type:`separator`},{type:`button`,id:`bulletList`,icon:`bulletList`,title:t.bulletList,command:`bulletList`,isActive:e=>e.getActiveBlockType()===`bullet_list`},{type:`button`,id:`orderedList`,icon:`orderedList`,title:t.orderedList,command:`orderedList`,isActive:e=>e.getActiveBlockType()===`ordered_list`},{type:`separator`},{type:`button`,id:`link`,icon:`link`,title:t.insertLink,command:`link`},{type:`button`,id:`image`,icon:`image`,title:t.insertImage,command:`image`},{type:`button`,id:`blockquote`,icon:`blockquote`,title:t.blockquote,command:`blockquote`},{type:`button`,id:`hr`,icon:`hr`,title:t.horizontalRule,command:`hr`},{type:`button`,id:`callout`,icon:`callout`,title:t.insertCallout,command:`callout`,isActive:e=>e.getActiveBlockType().startsWith(`CALLOUT-`)}]}q(G);function De(e,t=G){let n=q(t).filter(t=>t.type===`separator`||t.type===`spacer`?!0:`id`in t&&e.includes(t.id)),r=[];for(let e of n)if(e.type===`separator`){let t=r[r.length-1];if(!t||t.type===`separator`||t.type===`spacer`)continue;r.push(e)}else r.push(e);for(;r.length>0;){let e=r[r.length-1];if(e.type===`separator`||e.type===`spacer`)r.pop();else break}return r}var Oe=`oe-callout-picker-styles`;function ke(){if(document.getElementById(Oe))return;let e=document.createElement(`style`);e.id=Oe,e.textContent=`
.oe-callout-picker {
  position: fixed;
  z-index: 10000;
